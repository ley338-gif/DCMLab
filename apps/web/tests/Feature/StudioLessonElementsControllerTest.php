 ...
 */
class StudioLessonElementsControllerTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_a_learner_cannot_view_the_element_sequence(): void
    {
        ...
        $this->actingAs($learner)
            ->get("/de/studio/lessons/{$lesson->lesson_id}/elements")
            ->assertForbidden();
    }
    ...
    public function test_an_author_sees_the_element_sequence_in_order(): void
    {
        ...
        $this->actingAs($author)
            ...
            ->assertInertia(fn ($page) => $page
                ->component('Studio/Lessons/Elements')
                ->has('elements', 2)
    ...
    public function test_a_reviewer_can_reorder_the_elements(): void
    {
        ...
        $this->actingAs($reviewer)
            ->patch("/de/studio/lessons/{$lesson->lesson_id}/elements/reorder", [
    ...
    public function test_an_unassigned_author_cannot_reorder(): void
    {
        ...
        $this->actingAs($author)
            ->patch("/de/studio/lessons/{$lesson->lesson_id}/elements/reorder", ['order' => [$content->id]])
            ->assertForbidden();
    ...
    public function test_an_assigned_author_can_attach_a_published_lab(): void
    {
        ...
        $this->actingAs($author)
            ->post("/de/studio/lessons/{$lesson->lesson_id}/elements/labs", ['lab_slug' => 'c-echo-live'])
            ->assertRedirect();
    ...
    public function test_attaching_an_unpublished_lab_is_rejected(): void
    {
        ...
        $this->actingAs($reviewer)
            ->post("/de/studio/lessons/{$lesson->lesson_id}/elements/labs", ['lab_slug' => 'draft-lab'])
            ->assertSessionHasErrors('lab_slug');
