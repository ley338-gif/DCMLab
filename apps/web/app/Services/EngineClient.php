...
/**
 * Duenner HTTP-Client fuer die Node-Engine (Abschnitt 3.3, 5.5). Kennt keine
...
final class EngineClient
{
    ...
    {
        return Http::baseUrl(config('services.engine.url'))
            ->withHeaders(['X-DCMLAB-KEY' => config('services.engine.key')])
            ->timeout(10);
    }
}
